...
object PytestRegexp {
    ...
    const val ALLURE_TITLE = ALLURE_METHOD + "title"
    const val ALLURE_DESCRIPTION = ALLURE_METHOD + "description"
    const val ALLURE_DESCRIPTION_HTML = ALLURE_METHOD + "description_html"
    const val ALLURE_LINK = ALLURE_METHOD + "link" + EVERYTHING_IN_PARENTHESES
    const val ALLURE_ISSUE = ALLURE_METHOD + "issue" + EVERYTHING_IN_PARENTHESES
    const val ALLURE_TESTCASE = ALLURE_METHOD + "testcase" + EVERYTHING_IN_PARENTHESES
    const val ALLURE_TAG = ALLURE_METHOD + "tag"
    const val ALLURE_LABEL = ALLURE_METHOD + "label"
    const val ALLURE_ID = ALLURE_METHOD + "id"
    const val ALLURE_EPIC = ALLURE_METHOD + "epic"
    const val ALLURE_FEATURE = ALLURE_METHOD + "feature"
    const val ALLURE_STORY = ALLURE_METHOD + "story"
    const val ALLURE_PARENT_SUITE = ALLURE_METHOD + "parent_suite"
    const val ALLURE_SUITE = ALLURE_METHOD + "suite"
    const val ALLURE_SUB_SUITE = ALLURE_METHOD + "sub_suite"
