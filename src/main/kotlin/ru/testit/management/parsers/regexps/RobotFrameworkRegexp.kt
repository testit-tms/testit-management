...
object RobotFrameworkRegexp {
    ...
    const val ALLURE_FEATURE_LABEL_NAME = "feature"
    ...
    const val ALLURE_FEATURE = ALLURE_LABEL + ALLURE_FEATURE_LABEL_NAME + KEY_VALUE_SEPARATOR
    ...
    const val ALLURE_ID = ALLURE_METHOD + ALLURE_ID_LABEL_NAME + KEY_VALUE_SEPARATOR + KEY_VALUE_SEPARATOR
    ...
    const val LABEL_ID_VALUE_ANNOTATION = "$ALLURE_METHOD(?<$LABEL_VALUE_ANNOTATION_NAME>\\S+)"
    ...
    const val TMS_LABELS = TMS_METHOD_OBJECT + "labels" + KEY_VALUE_SEPARATOR
    const val TMS_LINKS = TMS_METHOD_OBJECT + "links" + KEY_VALUE_SEPARATOR
    const val TMS_NAMESPACE = TMS_METHOD_OBJECT + "nameSpace" + KEY_VALUE_SEPARATOR
    const val TMS_CLASSNAME = TMS_METHOD_OBJECT + "className" + KEY_VALUE_SEPARATOR
    const val TMS_DISPLAY_NAME = TMS_METHOD_OBJECT + "displayName" + KEY_VALUE_SEPARATOR
